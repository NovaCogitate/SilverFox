...
class NiftiPairImageGenerator(Dataset):
    ...
    def pair_file(self):
        ...
        pairs = []
        for input_file, target_file1, target_file2, target_file3, target_file4 in zip(
            input_files, target_files1, target_files2, target_files3, target_files4
        ):
            ...
            pairs.append(
                (input_file, target_file1, target_file2, target_file3, target_file4)
            )
        return pairs
    ...
    def __getitem__(self, index):
        ...
        target_img = np.stack(
            [target_img1, target_img2, target_img3, target_img4], axis=3
        )
